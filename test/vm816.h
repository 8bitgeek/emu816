...
class vm816 : public emu816
{
    public:
        ...
        virtual uint8_t         getByte(emu816_addr_t ea);
        virtual uint16_t        getWord(emu816_addr_t ea);
        virtual emu816_addr_t   getAddr(emu816_addr_t ea);
        virtual void            setByte(emu816_addr_t ea, uint8_t data);
        virtual void            setWord(emu816_addr_t ea, uint16_t data);
